...
describe("AppointmentService", () => {
  ...
  describe("CreateAppointmentAsync", () => {
    ...
    it("should throw if slot has already ended", async () => {
      ...
      await expect(service.CreateAppointmentAsync(dto)).rejects.toThrow("slot has already ended");
    });
    ...
    it("should throw if slot is already full", async () => {
      ...
      const dto = new CreateAppointmentDto();
      await expect(service.CreateAppointmentAsync(dto)).rejects.toThrow("slot is already full");
    });
  });
});
